...
class RecipeCard extends HTMLElement {
  ...
  `;
    ...
    shadowOpen.append(artEl);
    shadowOpen.append(styleEl);
  }
  ...
  set data(data) {
    ...
    let varArticle = this.shadowRoot.querySelector('article');
    // A7. TODO - Set the contents of the <article> with the <article> template given in
    //           cardTemplate.html and the data passed in (You should only have one <article>,
    //           do not nest an <article> inside another <article>). You should use Template
    //           literals (template strings) and element.innerHTML for this.
    varArticle.innerHTML = `<img src="https://link-to-article.com/recipe-thumbnail.jpg"
    alt="Recipe Title">
    <p class="title">
